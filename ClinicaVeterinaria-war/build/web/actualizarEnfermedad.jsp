<%-- 
    Document   : actualizarEnfermedad
    Created on : 20-07-2020, 17:56:34
    Author     : Artsk
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s8 offset-s2 card-panel z-depth-5">
                    <p class="center-align">Actualizar Enfermedad</p>
                    <form class="col s12" action="actualizarEnfermedad.do" method="post">
